...
import {InvoicesUrl, ProformaUrl, SalesOrdersUrl} from "../UrlHelper";
...
export default function SalesMenuItem() {
    ...
    return <React.Fragment>
        ...
        <Collapse in={index === 2}>
            ...
            <SubMenuItem text={"Sales Orders"} loc={SalesOrdersUrl}/>
            <SubMenuItem text={"Invoices"} loc={InvoicesUrl}/>
            <SubMenuItem text={"Profoma"} loc={ProformaUrl}/>
            </div>
        </Collapse>
    </React.Fragment>
}