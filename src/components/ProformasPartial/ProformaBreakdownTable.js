...
export default function ProformaBreakdownTable({data: v, totalAmount, totalDiscount}) {
    const invRef = useRef();
    ...
    return <div id="order-brk">
        ...
        <div ref={invRef}>
            <div className="grid gap-8 grid-cols-2">
                {/*    left*/}
                <div className="flex flex-col">
                    <span className="text-xl font-bold">PROFORMA INVOICE</span>
                    <span className="text-gray-600">Proforma# <b>{v?.OrderId}</b></span>
                    ...
                    <span className="text-gray-600 uppercase text-xs">Reference# &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <span className="text-gray-600 uppercase text-xs">Proforma Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div className="flex flex-col space-y-2">
                    <span className="text-xl">Billing Address</span>
                    <span className="text-base text-gray-600">{v?.Customer?.CustomerName}</span>
                    <div className="flex flex-col mt-4 text-gray-600 text-xs">
