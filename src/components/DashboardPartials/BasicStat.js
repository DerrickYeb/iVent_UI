...
export default function BasicStat(){
    return <div class="grid gap-6 mb-6 md:grid-cols-2 xl:grid-cols-4">
        <div
        ...
        >
            <div class="p-4 flex items-center">
                ...
                <div>
                    <Tooltip withArrow={true} color={"blue"} label={"SalesOrders Pending Delivery from Suppliers"}>
                        <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                            Pending Suppliers Delivery
                        </p>
                    </Tooltip>
        ...
        >
            <div className="p-4 flex items-center">
                ...
                <div>
                    <Tooltip withArrow={true} color={"blue"} label={"Sales SalesOrders Pending Payment from Customers"}>
                        <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
        ...
        >
            <div className="p-4 flex items-center">
                <div
                    className="p-3 rounded-full text-teal-500 bg-red-100 mr-4"
                >
                ...
                <div>
                    <Tooltip withArrow={true} color={"blue"} label={"Customer orders that were marked as cancelled or declined"}>
                    <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
        ...
        >
            <div className="p-4 flex items-center">
                ...
                <div>
                    <Tooltip withArrow={true} color={"blue"} label={"Supplier orders that were marked as cancelled or declined"}>
                    <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">
                        Cancelled Supplier Orders
                    </p>
                    </Tooltip>
                    <p className="text-lg font-semibold text-gray-700 dark:text-gray-200">0</p>
                </div>
